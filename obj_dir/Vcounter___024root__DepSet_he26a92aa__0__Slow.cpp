...
#endif
            VL_FATAL_MT("my_design_tb.v", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vcounter___024root___ctor_var_reset(Vcounter___024root* vlSelf) {
    ...
    vlSelf->full_adder_tb__DOT__cout = VL_RAND_RESET_I(1);
    vlSelf->full_adder_tb__DOT__unnamedblk1__DOT__i = 0;
